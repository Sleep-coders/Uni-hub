...
public final class Student implements Model {
  ...
  public static final QueryField USER_REAL_NAME = field("Student", "user_real_name");
  public static final QueryField USER_NICKNAME = field("Student", "user_nickname");
  public static final QueryField USER_PHONE_NUMBER = field("Student", "user_phone_number");
  public static final QueryField USER_EMAIL = field("Student", "user_email");
  public static final QueryField USER_LOCATION = field("Student", "user_location");
  public static final QueryField USER_UNIVERSITY = field("Student", "user_university");
  public static final QueryField USER_IMG = field("Student", "user_img");
  ...
  private Student(String id, String user_real_name, String user_nickname, String user_phone_number, String user_email, String user_location, String user_university, String user_img) {
    this.id = id;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), student.getId()) &&
              ObjectsCompat.equals(getUserRealName(), student.getUserRealName()) &&
              ObjectsCompat.equals(getUserNickname(), student.getUserNickname()) &&
              ObjectsCompat.equals(getUserPhoneNumber(), student.getUserPhoneNumber()) &&
              ObjectsCompat.equals(getUserEmail(), student.getUserEmail()) &&
              ObjectsCompat.equals(getUserLocation(), student.getUserLocation()) &&
              ObjectsCompat.equals(getUserUniversity(), student.getUserUniversity()) &&
              ObjectsCompat.equals(getUserImg(), student.getUserImg()) &&
