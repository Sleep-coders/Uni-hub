...
public class PlayerInRoomGame extends AppCompatActivity {

    private static final String TAG = PlayerInRoomGame.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_in_room_game);
        ...
        CountDownTimer timer = new CountDownTimer(timeLeft, 1000) {
            ...
            public void onFinish() {
                ...
                sendGameDataThread = new Thread(() -> {
                    startActivity(new Intent(getApplicationContext(), PlayerGameGrading.class));
                });
